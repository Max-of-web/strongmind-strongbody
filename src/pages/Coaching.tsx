            ...
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12 w-full max-w-6xl mx-auto animate-fade-in">
              ...
              <div className="order-2 md:order-1 md:w-2/3 text-center md:text-left flex flex-col justify-center">
                ...
                <div className="flex items-center gap-4 justify-center">
                  <button onClick={scrollToPackages} className="bg-gradient-to-r from-amber-400 to-orange-400 text-black px-4 md:px-6 py-2 md:py-3 rounded-md font-bold text-sm md:text-base border border-amber-300/50 shadow-lg shadow-amber-500/25 hover:shadow-xl hover:shadow-amber-500/40 hover:from-amber-300 hover:to-orange-300 transition-all duration-300 hover:-translate-y-0.5 relative overflow-hidden">
                    <span className="relative z-10">Treniruočių paketai</span>
                  ...
                  <a 
                    ...
                    className="inline-flex items-center justify-center px-6 py-3 bg-white text-gray-900 hover:bg-gray-100 rounded-md font-medium transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-1"
