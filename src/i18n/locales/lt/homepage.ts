...
const homepage = {
  homepage: {
    ...
    lowerBackGuide: {
      ...
      intro: 'Iki 80 % žmonių bent kartą gyvenime patiria nugaros skausmą. Šiame gide – svarbiausi faktai ir 7 paprasti žingsniai, kaip suprasti priežastis ir pradėti veikti jau šiandien.',
      benefits: [
