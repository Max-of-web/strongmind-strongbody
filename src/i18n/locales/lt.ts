...
const translation = {
  ...
  applicationForm: {
    ...
    goalPlaceholder: 'pvz., Stiprinti raumenis, numesti svorį, pagerinti judesių amplitudę...',
    challenge: 'Su kokiais iššūkiais dabar susiduriate?',
    challengePlaceholder: 'pvz., Laiko trūkumas, traumos, motyvacija...',
    change: 'Ar esate pasiruošę įsipareigoti pokyčiams?',
  ...
  admin: {
    ...
    login: 'Administratoriaus Prisijungimas',
    password: 'Įveskite administratoriaus slaptažodį',
    loginButton: 'Prisijungti',
    logout: 'Atsijungti',
    contentEditor: 'Kalbų Turinio Redaktorius',
    applyChanges: 'Pritaikyti Pakeitimus',
    resetOriginal: 'Atstatyti į Originalą',
    changesApplied: 'Pakeitimai Pritaikyti',
    translationsReset: 'Vertimai Atstatyti',
    currentLanguage: 'Šiuo metu redaguojama kalba',
    loginSuccess: 'Prisijungimas Sėkmingas',
    loginFailed: 'Prisijungimas Nepavyko',
    welcomeMessage: 'Sveiki atvykę į administravimo skydelį',
