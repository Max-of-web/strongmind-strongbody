...
const LowerBackGuide = () => {
  ...
  return (
    <section className="py-20 bg-elegant-offwhite dark:bg-elegant-charcoal">
          ...
          <div className="md:w-1/2 bg-white dark:bg-slate-800 rounded-md mx-0 px-[35px] py-[30px]">
            ...
            <ul className="space-y-4 mb-8">
              <li className="flex items-start">
                ...
                <span className="text-foreground">Identify the root causes of your lower back pain</span>
              </li>
              <li className="flex items-start">
                <Check size={22} className="text-theme-tangerine shrink-0 mt-1 mr-3" />
                <span className="text-foreground">Implement immediate relief techniques</span>
              </li>
              <li className="flex items-start">
                <Check size={22} className="text-theme-tangerine shrink-0 mt-1 mr-3" />
                <span className="text-foreground">Strengthen key stabilizing muscles</span>
              </li>
              <li className="flex items-start">
                <Check size={22} className="text-theme-tangerine shrink-0 mt-1 mr-3" />
                <span className="text-foreground">Modify your daily activities to prevent reinjury</span>
              </li>
              <li className="flex items-start">
                <Check size={22} className="text-theme-tangerine shrink-0 mt-1 mr-3" />
                <span className="text-foreground">Develop a progressive exercise routine that's safe for your back</span>
              </li>
            </ul>

            <div className="flex items-center text-foreground text-sm mt-10 border-t border-input pt-4">
              <Shield size={18} className="mr-2 text-theme-tangerine" />
              <span className="dark:text-white">Your email is safe with me. I'll never share it with anyone else.</span>
            </div>
          </div>
