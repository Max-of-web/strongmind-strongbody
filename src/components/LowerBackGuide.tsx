...
const LowerBackGuide: React.FC = () => {
  ...
  const benefits = t('homepage.lowerBackGuide.benefits', { returnObjects: true }) as string[] || [
    'Išmokite taisyklingai tempti nugarą',
    'Atlikite tempimo pratimus saugiai',
    'Sumažinkite skausmą per 10 minučių',
    'Pagerinkite laikyseną',
    'Stiprinkite nugaros raumenis',
    'Išvenkite ateities traumų'
  ];
