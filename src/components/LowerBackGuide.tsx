...
const LowerBackGuide = () => {
  ...
  return (
    <section className="py-20 bg-slate-100 dark:bg-elegant-charcoal">
      <div className="container-width px-4 md:px-8">
        <div className="flex flex-col md:flex-row gap-10 items-stretch">
          ...
          <div className="md:w-1/2 bg-white dark:bg-slate-800 rounded-md mx-0 px-[35px] py-[30px]">
            ...
            <p className="mb-6 text-theme-darknavy dark:text-white text-lg">
              Lower back pain affects up to 80% of adults at some point in their lives. 
              But you don't have to live with it.
            </p>
            <p className="mb-8 text-theme-darknavy dark:text-white text-lg">
            ...
            <ul className="space-y-4 mb-8">
              <li className="flex items-start">
                ...
                <span className="text-theme-darknavy dark:text-white">Identify the root causes of your lower back pain</span>
              </li>
              <li className="flex items-start">
                <Check size={22} className="text-theme-tangerine shrink-0 mt-1 mr-3" />
                <span className="text-theme-darknavy dark:text-white">Implement immediate relief techniques</span>
              </li>
              <li className="flex items-start">
                <Check size={22} className="text-theme-tangerine shrink-0 mt-1 mr-3" />
                <span className="text-theme-darknavy dark:text-white">Strengthen key stabilizing muscles</span>
              </li>
              <li className="flex items-start">
                <Check size={22} className="text-theme-tangerine shrink-0 mt-1 mr-3" />
                <span className="text-theme-darknavy dark:text-white">Modify your daily activities to prevent reinjury</span>
              </li>
              <li className="flex items-start">
                <Check size={22} className="text-theme-tangerine shrink-0 mt-1 mr-3" />
                <span className="text-theme-darknavy dark:text-white">Develop a progressive exercise routine that's safe for your back</span>
              </li>
            </ul>
            ...
            <div className="flex items-center text-sm mt-10 border-t border-slate-200 dark:border-slate-700 pt-4">
              ...
              <span className="text-theme-darknavy dark:text-white">Your email is safe with me. I'll never share it with anyone else.</span>
            </div>
          </div>
